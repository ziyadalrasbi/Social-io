...
class ElementsBordersPage extends StatefulWidget {
  @override
  _ElementsBordersPageState createState() => _ElementsBordersPageState();
}

class _ElementsBordersPageState extends State<ElementsBordersPage> {


Map<String,int> borders = {
  "assets/borders/elements/element1.png": 0,
  "assets/borders/elements/element2.png": 20,
  "assets/borders/elements/element3.png": 40,
};
