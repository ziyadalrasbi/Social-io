...
class NatureProfilePicPage extends StatefulWidget {
  @override
  _NatureProfilePicPageState createState() => _NatureProfilePicPageState();
}

class _NatureProfilePicPageState extends State<NatureProfilePicPage> {
