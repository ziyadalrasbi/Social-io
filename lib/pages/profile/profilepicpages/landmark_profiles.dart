...
class LandmarkProfilePicPage extends StatefulWidget {
  @override
  _LandmarkProfilePicPageState createState() => _LandmarkProfilePicPageState();
}

class _LandmarkProfilePicPageState extends State<LandmarkProfilePicPage> {
