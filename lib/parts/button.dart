...
class MainButton extends StatelessWidget {
  ...
  MainButton({
    ...
    this.color = primaryDarkColour, // the colour of the button
    this.textColor = Colors.white, // the text colour on the button
  }) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return Container( // a container that holds the different information about the buttion dimensions
      ...
      margin: EdgeInsets.symmetric(vertical: 15), // the margin of the button, making space below and above it
